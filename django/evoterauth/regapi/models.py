...
class API(models.Model):
    ...
    api_key=models.IntegerField(primary_key=True,unique=True)
    api_secret=models.CharField(max_length=255)
    api_id=models.IntegerField(unique=True)
    callback_url=models.TextField(validators=[URLValidator()],null=True,blank=True)
    redirect_url=models.TextField(validators=[URLValidator()],null=True,blank=True)
...
class Allowed_user(models.Model):
    ...
    def __str__(self):
        return self.api.api_name+' '+self.user.username 
